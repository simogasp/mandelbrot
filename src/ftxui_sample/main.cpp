...
// configuration step. It creates a namespace called `mandelbrot`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", mandelbrot::cmake::project_name, mandelbrot::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", mandelbrot::cmake::project_version);
      return EXIT_SUCCESS;
    }
